...
export default function LearnTopic() {
  ...
  const loadLesson = () => {
    ...
    axios
      .get(`https://ai-learning-webapplication.onrender.com/api/topic/learn/${topicId}`, {
  ...
  const upgradePlan = async () => {
    try {
      ...
      await axios.post(
        "https://ai-learning-webapplication.onrender.com/api/subscription/upgrade",
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const generateAssignment = async () => {
    try {
      ...
      const res = await axios.post(
        `https://ai-learning-webapplication.onrender.com/api/assignment/generate/${topicId}`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
